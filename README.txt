...
En la carpeta DB se encuentra el archivo exportado sql de la base de datos MySQL utilizada
...
Tanto el back end como el front end y la base de datos MySQL se encuentran alojados en diferentes servidores gratuitos.

La aplicación funcional se puede probar en la siguiente dirección:
